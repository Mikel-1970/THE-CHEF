...
export function ResultsPage() {
  ...
  const [engineNotice, setEngineNotice] = useState<string | undefined>(() => {
    try { return sessionStorage.getItem(HYBRID_NOTICE_STORAGE_KEY) ?? undefined; }
  ...
  return (
    <AppShell hideBack hideProfile>
      <ChefLoadingOverlay
        ...
        messages={generatingId ? ['¡Oído cocina!'] : ['Buscando opciones diferentes…']}
      />
      <TopBar eyebrow={`${visibleCount} IDEAS PARA ELEGIR`} title="¿Con cuál te quedas?" />
      <div className="page-content results-content nav-safe">
