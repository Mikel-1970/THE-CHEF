...
export function ShoppingListPage() {
  ...
  const { shoppingList, toggleShoppingItem, removeShoppingItem, clearShoppingList, upsertShoppingItem, settings } = useApp();
