...
export function libraryImage(id:string,thumbnail=false){return isLibraryRecipe(id)?`${import.meta.env.BASE_URL}library/${id}${thumbnail?'_min':''}.webp?v=plated-20260926`:undefined;}
