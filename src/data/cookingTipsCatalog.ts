import type { CookingTip } from './cookingTips';

// Datos editoriales separados del runtime para no inflar el bundle principal.
export const cookingTipsCatalog:CookingTip[] = [
  {
    "id": "tip-v2-001",
    "code": "TIP-001",
    "icon": "🧭",
